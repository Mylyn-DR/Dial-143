...
public class Day6Rosario implements DayInterface {
    ...
    private static final SceneEntry[] MORNING = {
        ...
        SceneEntry.dialogue("CoWorker A", "Hey, have you seen Sir Rosario today?", "single:CoWorker_Neutral", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker B", "Not yet. Maybe he's preparing something for the event.", "single:CoWorker_Neutral", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker C", "Oh… I hear that it's true that he prepares something special.", "single:CoWorker_Neutral", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker A", "Actually… have you noticed Sir Rosario lately?", "single:CoWorker_Smile", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker C", "Why? What does Sir Rosario do?", "single:CoWorker_Curious", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker B", "Well… he's been smiling a lot these days.", "single:CoWorker_Smile", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker A", "And sometimes he just stares at his phone with his heart-eye look.", "single:CoWorker_Smile", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker B", "I noticed that too!", "single:CoWorker_Laugh", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker C", "Really??? I think someone has already made him happy… Hmmmm… who's that lucky person?", "single:CoWorker_Surprised", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker A", "He's not like that before… I wonder who made him like that.", "single:CoWorker_Smile", "MorningElevator.jpg"),
        SceneEntry.dialogue("{name}", "(mind) Heart-eyes??? Someone made him happy???? Wait… are they talking about…?", "none", "MorningElevator.jpg"),
        SceneEntry.dialogue("CoWorker B", "Whoever it is, that person must be really special to him.", "single:CoWorker_Smile", "MorningElevator.jpg"),
