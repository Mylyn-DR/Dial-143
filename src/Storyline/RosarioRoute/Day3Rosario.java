...
public class Day3Rosario implements DayInterface {
    ...
    private static final ChoiceEntry[] CHOICES_FIRST = {
        new ChoiceEntry("Run after them", 5, 0, Character.ROSARIO,
            ...
            SceneEntry.dialogue("Rosario", "…It was pretty expensive, but worth the money.", "double:Amaya_Casual:Rosario_Casual", "StreetEvening.jpg"),
            SceneEntry.dialogue("Amaya", "Uh-huh…", "double:Amaya_Casual:Rosario_Casual", "StreetEvening.jpg"),
            SceneEntry.dialogue("Amaya", "Oh! That's my bus!", "double:Amaya_Casual:Rosario_Casual", "StreetEvening.jpg"),
