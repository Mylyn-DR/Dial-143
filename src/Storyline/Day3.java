...
public class Day3 implements DayInterface {
    ...
    private static final SceneEntry[] MORNING = {
        ...
        SceneEntry.choiceMarker("MORNING_CHOICE_1"),  // ← Changed
        ...
        SceneEntry.choiceMarker("MORNING_CHOICE_2"),  // ← Changed
        ...
        SceneEntry.choiceMarker("MORNING_CHOICE_3"),  // ← Changed
        ...
        SceneEntry.choiceMarker("MORNING_CHOICE_4"),  // ← Changed
    ...
    // Choice arrays remain the same
    private static final ChoiceEntry[] CHOICES_M7 = {
        new ChoiceEntry("Formal Reply", 2, 3, Character.CLOMA,
    ...
    private static final ChoiceEntry[] CHOICES_M10 = {
        new ChoiceEntry("Greet", 5, 3, Character.CELERES,
    ...
    private static final ChoiceEntry[] CHOICES_M21 = {
        new ChoiceEntry("Ask Rosario", 2, 0, Character.ROSARIO,
        ...
        new ChoiceEntry("Ask Amaya", 2, 0, Character.AMAYA,
        ...
        new ChoiceEntry("Ask Celeres", 5, 0, Character.CELERES,
    ...
    private static final ChoiceEntry[] CHOICES_M33 = {
        ...
        new ChoiceEntry("Offer cash to Amaya", 5, 3, Character.AMAYA, 
        ...
        new ChoiceEntry("Reprimand Amaya", 2, 0, Character.AMAYA,
    ...
    // Choice map for markers
    private static final Map<String, ChoiceEntry[]> choiceMap = new HashMap<>();
    static {
        choiceMap.put("MORNING_CHOICE_1", CHOICES_M7);
        choiceMap.put("MORNING_CHOICE_2", CHOICES_M10);
        choiceMap.put("MORNING_CHOICE_3", CHOICES_M21);
        choiceMap.put("MORNING_CHOICE_4", CHOICES_M33);
    }
    ...
    public ChoiceEntry[] getChoicesForMarker(String choiceId) {
        System.out.println("Day3.getChoicesForMarker(" + choiceId + ") called");
