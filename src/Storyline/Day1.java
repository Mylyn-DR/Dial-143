...
public class Day1 implements DayInterface {
    ...
    private static final SceneEntry[] EVENING = {
        ...
        SceneEntry.choiceMarker("EVENING_CHOICE_1"),  // ← Changed
        ...
        SceneEntry.choiceMarker("EVENING_CHOICE_2"),  // ← Changed
    ...
    private static final ChoiceEntry[] CHOICES_M7 = {
        new ChoiceEntry("Who are you?", 3, 0, Character.ROSARIO,
    ...
    private static final ChoiceEntry[] CHOICES_M11 = {
        new ChoiceEntry("What's my role?", 5, 0, Character.ROSARIO,
    ...
    private static final ChoiceEntry[] CHOICES_E10 = {
        new ChoiceEntry("Tease", 3, 0, Character.AMAYA,
        ...
        new ChoiceEntry("Grateful", 5, 3, Character.AMAYA,
    ...
    static {
        ...
        choiceMap.put("MORNING_CHOICE_2", CHOICES_M11);
        choiceMap.put("EVENING_CHOICE_1", CHOICES_E10);
        choiceMap.put("EVENING_CHOICE_2", CHOICES_E14);
    }
    ...
    public ChoiceEntry[] getChoicesForMarker(String choiceId) {
        System.out.println("Day1.getChoicesForMarker(" + choiceId + ") called");
