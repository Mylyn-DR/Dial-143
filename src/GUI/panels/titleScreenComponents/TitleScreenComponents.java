...
public class TitleScreenComponents extends JPanel {
    ...
    private ImageButtonCreation btnCredits;
    ...
    private void initComponents() {
        ...
        btnCredits = new ImageButtonCreation("Credits");
        btnCredits.setBounds(108, 540, 236, 38);
        btnCredits.addActionListener(e -> { if (onCredits != null) onCredits.run(); });
        add(btnCredits);
        
        btnExit = new ImageButtonCreation("Exit");
        btnExit.setBounds(108, 588, 236, 38);
    ...
    public void setButtonImage(String filename) {
        ...
        btnCredits.setImage(filename);
    }

    /** Apply individual images per button; pass null to keep the default style. */
    public void setButtonImages(String playFile, String saveFile, String exitFile, String creditsFile) {
        ...
        if (creditsFile != null) btnCredits.setImage(creditsFile);
    }
    ...
    public void setCreditsAction(Runnable action) { this.onCredits = action;}
}