...
public class TopBarComponents extends JPanel {
    ...
    public void updateLoveMeterVisibility(int currentDay, GameAPI.Segment segment) {  // ← Changed to GameAPI.Segment
        ...
        if (currentDay > 3) {
            shouldShow = true;
        } else if (currentDay == 3 && segment == GameAPI.Segment.EVENING) {
            shouldShow = true;
        } else if (currentDay == 3 && segment == GameAPI.Segment.ENDING) {
            shouldShow = true;
        }
    ...
    public void updateForShift(int day) {
        ...
        updateLoveMeterVisibility(day, GameAPI.Segment.MORNING);
    }

    public void updateForShop(int day) {
        setDayInfo(day, "Shop");
        updateLoveMeterVisibility(day, GameAPI.Segment.EVENING);
    }
